...
<div class=" flex gap-1 info" style={{alignItems: "center"}}>
    <div class="col-6">
        ...
        <a href="#">Butterfly Milkweed (Asclepias tuberosa)</a>,   <a href="#">Blanket Flower (Gaillardia pulchella)</a>,   <a href="#">Coral Honeysuckle (Lonicera sempervirens)</a>
    ...
    <div class="col-6">
        <img class="h-image" src="/img/maypop2.png" alt="maypop passion vine" width="100%" />
    </div>
</div>
<div class="flex  gap-1 info" style={{alignItems: "center"}}>
    <div class="col-6">
