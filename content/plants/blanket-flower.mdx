...
---
<div className=" flex gap-1 info" style={{ alignItems: "center" }}>
  <div className="col-6">
    ...
    <p>
      <a href="#">Coontie Palm (Zamia pumila)</a>,
      <a href="#">Saw Palmetto (Serenoa repens)</a>,
      <a href="#">Sand Cordgrass (Spartina bakeri)</a>
    </p>
    <p>
  ...
  <div class="col-6">
    <img class="h-image" src="/img/blanket-flower-2.png" alt="Blanket Flower" width="100%" />
  </div>
</div>

<div class="flex gap-1 info" style={{ alignItems: "center" }}>
  <div class="col-6">
    <img class="h-image" src="/img/blanket-flower-3.png" alt="Blanket Flower" width="100%" />
  </div>
  <div class="col-6">
    ...
    <h3>Take Control of Pests</h3>
     <img class="h-image" src="/img/aphids.jpg" alt="Blanket Flower" width="100%" />
       <p>
